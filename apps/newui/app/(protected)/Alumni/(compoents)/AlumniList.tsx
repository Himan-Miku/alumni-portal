  ...
  return (
    <>
     ...
     <div className='flex bg-white m-2 rounded-xl w-full '>
        <Image src="/Search.svg" alt='Search icon' width={20} height={20} className='m-2 ml-4 border-none'></Image>
        <Input className=' m-2' ></Input>
     </div>
     <div className='flex justify-center items-center bg-white m-2 p-2 rounded-xl ' onClick={(Lis)=>{setListView(false)}}>
