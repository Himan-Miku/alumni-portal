  ...
  return (
    <div className="bg-white flex flex-col gap-5 pb-3 shadow-sm rounded-sm">
      <div className="flex gap-1 flex-col pt-2 px-2 md:px-6">
        ...
        <div className="mx-7 text-sm md:text-md font-semibold text-lightgray">
          {data?.about}
        </div>
      </div>
            ...
            return (
              <div key={ind} className="about-card">
                <div className="flex flex-col font-semibold">
                  <div className="text-base md:text-lg ">{elem?.role}</div>
        ...
        <div className="about-flex">
          {data?.qual.map((elem, ind) => {
            return (
              <div key={ind} className="about-card">
                <div className="flex flex-col font-semibold">
                  <div className="text-base md:text-lg">{elem?.stream}</div>
                  <div className="text-lightgray text-sm max-w-[90%] ">
                    {elem?.college}
                  </div>
